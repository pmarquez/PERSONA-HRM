...
<html>
  ...
  <body>
              ...
              <form class="login-wrapper" id="pwdRec01Form" name="pwdRec01Form">
                ...
                <div class="content">
                    <div id="pwdRecAlert" class="alert alert-block alert-info fade in no-margin">
                        <h4 style="margin-bottom: 6px;" id="messageCaption">Bienvenida(o) al proceso de regeneración de contraseña.</h4>
                        <p>
                            <span id="message">Para iniciar el proceso de regeneración de su contraseña, por favor escriba el email con el que usted se encuentra registrada(o) en nexfidelitas.</span>
                        </p>
                    </div>
                    
                    <div class="form-group" id="emailHolder">
                        <input type="text" class="form-control" name="email" id="email" placeholder="Direcci&oacute;n de Correo Electr&oacute;nico" value="">
                        <span class="help-block" id="username_issues"></span>
                    </div>
                </div>
                <div class="actions">
                    <button type="button" class="btn btn-info" id="processBtn">Iniciar Proceso</button>
    ...
    <script src="js/nexfidelitas/pwdRec01.js"></script>
  </body>
</html>